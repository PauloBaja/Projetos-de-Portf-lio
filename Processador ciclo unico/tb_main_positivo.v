...
module tb_main_positivo;
    ...
    initial begin
        $dumpfile("tb_main_positivo.vcd");
        $dumpvars(0, tb_main_positivo);
        ...
        $display("=== RESULTADO DA MEMÓRIA DE DADOS BUSCA POSITIVA ===");
      ...
      // ================= REGISTRADORES FINAIS (TABELA DETALHADA) =================
        $display("\n=== REGISTRADORES DEPOIS DA BUSCA POSITIVA ===");
